...
export const createInitialState = (
  ...
  // Create test messages for scrolling development (disabled in tests)
  const testMessages = includeTestMessages
    ? [
        ...
        createMessage(
          "user",
          "Should I use overflow: hidden on the chat area?",
        ),
        createMessage(
          "agent",
...
export const AppContextProvider: React.FC<AppContextProviderProps> = ({
  ...
  const [state, dispatch] = useReducer(
    appReducer,
    createInitialState(initialCwd, debugMode, includeTestMessages),
  );
